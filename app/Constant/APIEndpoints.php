...
class APIEndpoints{
    ...
    public const V1_WALLET_TRANSACTION_SEND_MONEY_STEP1 = '/api/v1/private/transaction/send-money/summary';
    public const V1_WALLET_TRANSACTION_SEND_MONEY_STEP2 = '/api/v1/private/transaction/send-money/execute';
